...
let gitName = "Feliz.QRCode"

// The name of the project
// (used by attributes in AssemblyInfo, name of a NuGet package and directory in 'src')
let project = "Feliz.QRCode"

let projectUrl = sprintf "%s/%s" gitHome gitName

// Short summary of the project
// (used as description in AssemblyInfo and as a short summary for NuGet package)
let summary = "Feliz React Binding for qrcode.react"

let copyright = "Copyright \169 2022"
let iconUrl = "https://raw.githubusercontent.com/tforkmann/Feliz.tQRCode/main/Feliz.QRCode_logo.png"
let licenceUrl = "https://github.com/tforkmann/Feliz.QRCode/blob/master/LICENSE.md"
let configuration = DotNet.BuildConfiguration.Release

// Longer description of the project
// (used as a description for NuGet package; line breaks are automatically cleaned up)
let description = """Feliz binding for qrcode.react."""
// List of author names (for NuGet package)
let authors = [ "Tim Forkmann"]
let owner = "tForkmann"
// Tags for your project (for NuGet package)
let tags = "fsharp;fable;qrcode.react;feliz;react;qrcode"
